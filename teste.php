...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.2.0/js/bootstrap-datepicker.min.js"></script> 
  ...
  <script>
   function ValidaForm()
   {
    ...
    {
     alert("CÃ³digo do ServiÃ§o vÃ¡lido somente entre 0 e 99999");
     return false;
    }
    if (!(document.forms["PagTesouro"]["referencia"].value >= 0 && document.forms["PagTesouro"]["referencia"].value <= 99999999999999999999))
    {
     alert("NÃºmero de ReferÃªncia vÃ¡lido somente entre 0 e 99999999999999999999");
     return false;
    }
   }
...
<link rel="shortcut icon" href="https://www.marinha.mil.br/papem/sites/all/themes/contrib/govbr_theme/favicon.ico" type="image/vnd.microsoft.icon" />
  <title>Portal de ConsignaÃ§Ãµes | PAPEM</title>
  <style>
 ...
 <body onload="FocoInicial()">
     ...
     <div class="all">
        <div class="row">
            <div class="center-align col s12">
                <!--<p>
                  <img src="Ã­ndice.png"><h5>Pagamento de GRU por meio do PagTesouro</h3><h7>(HomologaÃ§Ã£o)</h3><br>
  ...
  <div class="container">
    <div class="header-top">
      <div class="row">
        <div class="col-sm-7">
          <ul class="shortcuts"><li id="link-content"><a href="/papem/node/38#main-content" accesskey="1" class="active" style="color:white">Ir para o conteÃºdo <span style="color:white">1</span></a></li>
...
<li id="link-footer"><a href="/papem/node/38#footer" accesskey="4" class="active" style="color:white">Ir para o rodapÃ© <span style="color:white">4</span></a></li>
</ul>        </div>
        <div class="col-sm-5">
    ...
    <div class="header-main">
      <div class="row">
        <div class="col-sm-8 info">
          <div class="site-info">
                          <a class="logo navbar-btn pull-left" href="http://localhost/pagina/papemgru/papem.php" title="InÃ­cio">
                <img src="https://www.marinha.mil.br/papem/sites/www.marinha.mil.br.papem/files/%5Bremoval.ai%5D_tmp-624dedf80cb61%281%29%282%29_0.png" alt="InÃ­cio" />
              </a>
                        <a href="/papem/">
              ...
              <span class="subordination" style="color:white; margin: 107px; margin-top: -1%;">"Ordem, ProntidÃ£o e Regularidade"</span>
            </a>
          </div>
        </div>
        <div class="col-sm-4">
...
<div id="navbar" style="background:#0e4097;">
  <div class="container">
    <!-- .btn-navbar is used as the toggle for collapsed navbar content -->
          ...
          <div>
        <nav role="navigation">
          <ul class="menu secondary"><li class="first leaf"><a href="manualbp.pdf" download="manualbp.pdf" title="" style="color:white;">Manual PagTesouro</a></li>
<li class="leaf"><a href="http://www.planalto.gov.br/ccivil_03/_ato2011-2014/2011/lei/l12527.htm" title="" style="color:white;">Lei de Acesso Ã s InformaÃ§Ãµes</a></li>
<li class="last leaf"><a href="http://transparencia.gov.br/" title="" style="color:white;">Portal da TransparÃªncia</a></li>
</ul>        </nav>
      </div>
      </div>
</div>
...
<div id="main" class="main-container container">
  ...
  <header role="banner" id="page-header">
		...
		<?php
		if(isset($_GET['erro'])){
			echo "<div style='background-color:#FF0000; width:100%; height:25px; color:white; margin-top:-40px;'><center>O campo ".$_GET['erro']." nÃ£o foi preenchido, tente novamente.</center></div>";
		}	
		?>
      ...
      <form method="post" action="pagtesouroControl.php" name="PagTesouro" onsubmit="return ValidaForm()">
	   ...
	   <h1 style="color:#7F7F7F; font-family: 'Open Sans';">PagTesouro PAPEM</h1>
		<p style="color:red;"><strong style="color:red;">Obs:</strong> Habilite a opÃ§Ã£o de abertura de janelas, para a melhor utilizaÃ§Ã£o do sistema.</p>
	 <select class="form-control" id="exampleFormControlSelect1" name="naturezaD">
	  <option checked>Qual a natureza da devoluÃ§Ã£o?</option>
      <option onclick="pagamentoPessoal()" value="Ppessoal">Pagamento de pessoal</option><!-- codigo recolhimento: 68801-0 -->
      <option onclick="mostrarRecAtivos()" value="recAtivos">RecuperaÃ§Ã£o de Ativos (somente para o uso do SVPM)</option>
	  ...
	  <option checked>Qual a situaÃ§Ã£o funcional?</option>
	...
	<!-- REC ATIVOS -->
	<input class="form-control" placeholder="NOME" name="recAtivos_nome" type="text" class="competencia" style="display:none; margin-top: 2%;" id="recAtivos1">	
	<input class="form-control" placeholder="CPF" name="recAtivos_cpf" type="text" class="competencia" style="display:none; margin-top: 2%;" id="recAtivos2">
	<input class="form-control" placeholder="NIP" name="recAtivos_Nip" type="text" class="cpfcnpj" style="display:none; margin-top: 2%;" id="recAtivos3">
	<input class="form-control" placeholder="Exercicio Atual" name="recAtivos_exAtual" type="text" style="display:none; margin-top: 2%;" id="recAtivos4" onKeyPress="return(moeda(this,'.',',',event))">
	<input class="form-control" placeholder="Exercicio Anterior" name="recAtivos_exAnterior" type="text" style="display:none; margin-top: 2%;" id="recAtivos5" onKeyPress="return(moeda(this,'.',',',event))">
	...
	<input class="form-control" placeholder="Valor a ser recolhido" name="sisresSC_valorRecolhido" type="text" class="competencia" style="display:none; margin-top: 2%;" onKeyPress="return(moeda(this,'.',',',event))" id="sisresSC4">
	<!--<form>
	...
	<input class="form-control" placeholder="NIP" name="sisresOutros_Nip" type="text" class="cpfcnpj" style="display:none; margin-top: 2%;" id="sisresOutros3" maxlength="9">
	<input class="form-control" placeholder="Valor a ser recolhido" name="sisresOutros_valorRecolhido" type="text" class="competencia" style="display:none; margin-top: 2%;" onKeyPress="return(moeda(this,'.',',',event))" id="sisresOutros4">
	...
	<td style="vertical-align: middle; width: 50%; text-align: center;">			
          ...
          <td style="vertical-align: middle; width: 50%; text-align: center;">
           <label style="display:none" id="servidor3" >Processo de pagamento do recebimento indevido</label>
		   <label style="display:none" id="VeteranoAnistiado3" >Processo de pagamento do recebimento indevido</label>
		   <label style="display:none" id="pensionista3" >Processo de pagamento do recebimento indevido</label>
		   <label style="display:none" id="ativa3" >Processo de pagamento do recebimento indevido</label>
           <label style="display:none; margin:10px;" id="sisresSC5" >Processo de pagamento do recebimento indevido</label>
		   <label style="display:none; margin:10px;" id="sisresOutros5" >Processo de pagamento do recebimento indevido</label>
		   <br>
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
<script src="https://netdna.bootstrapcdn.com/bootstrap/2.3.2/js/bootstrap.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.2.0/js/bootstrap-datepicker.min.js"></script>
...
<input class="form-control" placeholder="MM/AAAA" type="text" style="display:none" id="servidor4" name="servidor4">
<script>
...
function IsPopupBlocker() {
    ...
    if (IsPopupBlocker()) {
        alert("O Bloqueador de abertura de janelas estÃ¡ ativado, para que o site funcione corretamente, desabilite essa opÃ§Ã£o no navegador. ");
    }
...
<input class="form-control" placeholder="MM/AAAA" name="VeteranoAnistiado4" type="text" style="display:none" id="VeteranoAnistiado4">
<script>
...
<input class="form-control" placeholder="MM/AAAA" name="pensionista4" type="text" style="display:none" id="pensionista4">
<script>
...
<input class="form-control" placeholder="MM/AAAA" name="ativa4" type="text" style="display:none" id="ativa4">
<script>
$("#ativa4").datepicker( {
format: "mm-yyyy",
viewMode: "months", 
...
<input class="form-control" placeholder="MM/AAAA" name="sisresSC6" type="text" style="display:none; margin:5px;" id="sisresSC6">
<script>
...
<input class="form-control" placeholder="MM/AAAA" name="sisresOutros5" type="text" style="display:none; margin:5px;" id="sisresOutros6">
<script>
...
minViewMode: "months"
	...
	<td style="vertical-align: middle; width: 50%; text-align: center;">
          ...
          <td style="vertical-align: middle; width: 50%; text-align: center;">  
           ...
           <input class="form-control" placeholder="NIP" name="veteranoNip" type="text" class="competencia" style="display:none" id="VeteranoAnistiado7" maxlength="9">
		   <input class="form-control" placeholder="NIP" name="pensionistaNip" type="text" class="competencia" style="display:none" id="pensionista7" maxlength="9">
		   <input class="form-control" placeholder="NIP" name="ativaNip" type="text" class="competencia" style="display:none" id="ativa7" maxlength="9">  
          </td>
		  <center>
		  <INPUT TYPE="RADIO" NAME="TipoTributo" VALUE="1" id="tributavel1" style="display:none" onclick="mostrarValorTributavel()"> <label id="tributavel2" style="display:none; margin-right:10%;">TributÃ¡vel</label>
          <INPUT TYPE="RADIO" NAME="TipoTributo" VALUE="2" id="ntribuavel1" style="display:none" onclick="mostrarValorNaoTributavel()"> <label id="ntributavel2" style="display:none">NÃ£o tributÃ¡vel</label>
          <br>
		  <input class="form-control" placeholder="Valor Bruto a ser recolhido" type="text" style="display:none; width:950;" id="servidorBruto" name="valorBruto" onKeyPress="return(moeda(this,'.',',',event))">
		  <input class="form-control" placeholder="Valor LÃ­quido a ser recolhido" type="text" style="display:none; width:950; margin-top:10px;" id="servidorLiquido" name="valorLiquido" onKeyPress="return(moeda(this,'.',',',event))">
	      </center>
		   <br>
	...
	<center><textarea id="storyPP" name="storyPP" placeholder="Motivo do recolhimento" rows="5" cols="33" style="display:none; margin-top:10px;" maxlength="200"></textarea></center>
     <center><textarea id="story" name="story" placeholder="Motivo do recolhimento" rows="5" cols="33" style="display:none; margin-top:-2%;" maxlength="200"></textarea></center>
 ...
 <!-- abaixo estÃ¡ o JavaScript responsavel por ocultar e fazer os campos aparecerem na pagina --> 
<script>
//FormataÃ§Ã£o Moeda
...
//abaixo leva as opÃ§Ãµes do campo do pagamento pessoal
function pagamentoPessoal(){
var pp = document.querySelector('#pp');
pp.style.display = "inline";
//apagar as opÃ§Ãµes do sisres da tela
...
//abaixo leva as opÃ§Ãµes do campo do Sisres
...
//mostra todos os campos dos Veterano/Anistiado, igual ao acima, porem de uma forma compactada (usando uma estrutura de repetiÃ§Ã£o
...
//buscar nome trabalha com a funÃ§Ã£o sql, pra ativar a pesquisa em tempo real
