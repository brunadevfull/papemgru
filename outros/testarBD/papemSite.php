 ...
 <body onload="FocoInicial()">
  ...
  <div class="container">
    <div class="header-top">
      <div class="row">
        <div class="col-sm-7">
          <ul class="shortcuts"><li id="link-content"><a href="/papem/node/38#main-content" accesskey="1" class="active">Ir para o conteúd <span>1</span></a></li>
...
<div id="main" class="main-container container">
  ...
  <header role="banner" id="page-header">
    ...
    <input class="form-control" placeholder="CPF" name="sisresOutros_cpf" type="text" class="competencia" style="display:none; margin-top: 2%;" id="sisresOutros1">
	<input class="form-control" placeholder="NIP" name="sisresOutros_Nip" type="text" class="cpfcnpj" style="display:none; margin-top: 2%;" id="sisresOutros2">
	...
	<td style="vertical-align: middle; width: 50%; text-align: center;">
           ...
           <input class="form-control" placeholder="CPF/CNPJ" name="veteranoCpfCnpj" type="text" class="competencia" style="display:none" id="VeteranoAnistiado6" class="cpfcnpj">
		   <input class="form-control" placeholder="CPF/CNPJ" name="pensionistaCpfCnpj" type="text" class="competencia" style="display:none" id="pensionista6" class="cpfcnpj">
		   <input class="form-control" placeholder="CPF/CNPJ" name="ativaCpfCnpj" type="text" class="competencia" style="display:none" id="ativa6" class="cpfcnpj">
		   <br>
          </td>
          <td style="vertical-align: middle; width: 50%; text-align: center;">  
		  ...
		  <center><br>
		  <input class="form-control" placeholder="Valor Bruto a ser recolhido" type="text" style="display:none; width:950;" id="servidorBruto" name="servidorvencimento" onKeyUp="mascaraMoeda(this, event)">
		  <input class="form-control" placeholder="Valor Liquido a ser recolhido" type="text" style="display:none; width:950; margin-top:10px;" id="servidorLiquido" name="servidorvencimento" onKeyUp="mascaraMoeda(this, event)">
	      </center>
		   <br>
	...
	<td style="vertical-align: middle; width: 50%; text-align: center;">
		...
		<center><?php include "lista_sisresOutros_OC.php"; ?>
		<?php include "sisresOutros_Recolhedora.php"; ?>
        <input class="form-control" placeholder="CPF/CNPJ" type="text" class="competencia" style="display:none; width:950px; margin-top:10px;" id="servidor6" class="cpfcnpj" name="servidorcpfcnpj">		
		</center>
	</tbody>
	</table>
	<img src="bp.png" style="height:30%; position: fixed; z-index:2; margin-top:-260px; margin-left: 10px;"></img>
...
for (var i = 0; i < 20; i++) {
   ...
   story.style.display = "inline";
   Oc.style.display = "Oc";
   OmRecolhedora.style.display = "OmRecolhedora";
   x++;
   x2++;
   x3++;
   }   
