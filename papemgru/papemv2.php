...
<div id="navbar" style="background:#0e4097;">
  <div class="container">
    <!-- .btn-navbar is used as the toggle for collapsed navbar content -->
          ...
          <div>
        <nav role="navigation">
          <ul class="menu secondary"><li class="first leaf"><a href="/papem/node/7" title="" style="color:white;">Contato</a></li>
<li class="leaf"><a href="/papem/node/8" title="" style="color:white;">Links Úteis</a></li>
  ...
  <header role="banner" id="page-header">
      ...
      <form method="post" action="pagtesouroControl.php" name="PagTesouro" onsubmit="return ValidaForm()">
	   ...
	   <h1 style="color:#7F7F7F; font-family: 'Open Sans';">PagTesouro PAPEM</h1>
		<p><strong style="color:red;">Obs:</strong> Habilite a opção do Pop-up no Browser, para a melhor utilização do sistema.</p>
	...
	<td style="vertical-align: middle; width: 50%; text-align: center;">			
          ...
          <td style="vertical-align: middle; width: 50%; text-align: center;">
           <label style="display:none" id="servidor3" >Mês do processo indevido</label>
		   <label style="display:none" id="VeteranoAnistiado3" >Mês do processo indevido</label>
		   <label style="display:none" id="pensionista3" >Mês do processo indevido</label>
		   <label style="display:none" id="ativa3" >Mês do processo indevido</label>
           <br>
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
<script src="https://netdna.bootstrapcdn.com/bootstrap/2.3.2/js/bootstrap.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.2.0/js/bootstrap-datepicker.min.js"></script>
...
minViewMode: "months"
	...
	<td style="vertical-align: middle; width: 50%; text-align: center;">
          ...
          <td style="vertical-align: middle; width: 50%; text-align: center;">  
           ...
           <input class="form-control" placeholder="Digite seu NIP" name="veteranoNip" type="text" class="competencia" style="display:none" id="VeteranoAnistiado7" maxlength="9">
		   <input class="form-control" placeholder="Digite seu NIP" name="pensionistaNip" type="text" class="competencia" style="display:none" id="pensionista7" maxlength="9">
		   <input class="form-control" placeholder="Digite seu NIP" name="ativaNip" type="text" class="competencia" style="display:none" id="ativa7" maxlength="9">  
          </td>
		  <center>
		  <INPUT TYPE="RADIO" NAME="TipoTributo" VALUE="1" id="tributavel1" style="display:none" onclick="mostrarValorTributavel()"> <label id="tributavel2" style="display:none; margin-right:10%;">Tributavel</label>
          <INPUT TYPE="RADIO" NAME="TipoTributo" VALUE="2" id="ntribuavel1" style="display:none" onclick="mostrarValorNaoTributavel()"> <label id="ntributavel2" style="display:none">Nao tributavel</label>
          <br>
		  ...
		  <input class="form-control" placeholder="Valor Liquido a ser recolhido" type="text" style="display:none; width:950; margin-top:10px;" id="servidorLiquido" name="valorLiquido" onKeyPress="return(moeda(this,'.',',',event))">
	      </center>
		   <br>
